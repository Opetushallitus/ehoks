...
| share-id | Uuid | Ulkoinen tunniste tiedon jakamista varten | Ei |
...
Aiemmin hankitun paikallisen tutkinnon osan tiedot uutta merkintää luotaessa (POST
