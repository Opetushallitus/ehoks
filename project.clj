(defproject oph.ehoks "0.1.0"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 ...
                 [environ "1.1.0"]
                 [clj-http "3.9.1" :exclusions [commons-codec]]
                 [com.taoensso/carmine "2.18.1" :exclusions [commons-codec]]
                 [hiccup "1.0.5"]]
  ...
  :profiles {:dev {:dependencies
                   [[javax.servlet/javax.servlet-api "4.0.1"]
                    ...
                    [ring/ring-mock "0.3.2" :exclusions [ring/ring-codec]]
                    [ring/ring-devel "1.7.0-RC2"
                     :exclusions [org.clojure/tools.namespace
                                  ring/ring-core ring/ring-codec joda-time]]]
