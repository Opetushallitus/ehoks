...
FROM aiemmin_hankitut_paikalliset_tutkinnon_osat osa
  ...
  LEFT OUTER JOIN aiemmin_hankitun_paikallisen_tutkinnon_osan_naytto AS naytto
    ON (osa.id = naytto.aiemmin_hankittu_paikallinen_tutkinnon_osa_id
