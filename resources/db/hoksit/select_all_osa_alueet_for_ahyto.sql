SELECT
  osa.id AS osa__id,
  osa.osa_alue_koodi_uri AS osa__osa_alue_koodi_uri,
  osa.osa_alue_koodi_versio AS osa__osa_alue_koodi_versio,
...
FROM aiemmin_hankitut_yto_osa_alueet osa
  ...
  LEFT OUTER JOIN aiemmin_hankitun_yto_osa_alueen_naytto AS naytto
    ON (osa.id = naytto.aiemmin_hankittu_yto_osa_alue_id
...
WHERE
  osa.aiemmin_hankittu_yhteinen_tutkinnon_osa_id = ?
