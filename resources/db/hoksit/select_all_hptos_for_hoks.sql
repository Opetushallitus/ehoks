SELECT
  ...
  osa.laajuus AS osa__laajuus,
  osa.nimi AS osa__nimi,
  osa.tavoitteet_ja_sisallot AS osa__tavoitteet_ja_sisallot,
  osa.amosaa_tunniste AS osa__amosaa_tunniste,
...
FROM hankittavat_paikalliset_tutkinnon_osat osa
  LEFT OUTER JOIN hankittavan_paikallisen_tutkinnon_osan_osaamisen_hankkimistavat
      AS osajoin
  ...
  LEFT OUTER JOIN hankittavan_paikallisen_tutkinnon_osan_naytto AS naytto
    ON (osa.id = naytto.hankittava_paikallinen_tutkinnon_osa_id
