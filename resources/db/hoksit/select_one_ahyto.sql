...
FROM aiemmin_hankitut_yhteiset_tutkinnon_osat osa
  ...
  LEFT OUTER JOIN aiemmin_hankitun_yhteisen_tutkinnon_osan_naytto AS naytto
    ON (osa.id = naytto.aiemmin_hankittu_yhteinen_tutkinnon_osa_id
