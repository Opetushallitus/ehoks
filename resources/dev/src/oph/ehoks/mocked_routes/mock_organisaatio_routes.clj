...
(def mock-routes
  (routes
    (POST "/organisaatio-service/api/findbyoids" request
          (mock-gen/json-response-file
            "dev-routes/organisaatio-service_api_findbyoids.json"))

    (GET "/organisaatio-service/api/1.2.246.562.15.404" []
      (assoc-in
        (response/not-found
    ...
    (GET "/organisaatio-service/api/1.2.246.562.10.5921222" []
      (mock-gen/json-response
        {:oid "1.2.246.562.10.5921222"
         :nimi {:fi "Testaus-organisaatio"}
         :parentOidPath "|1.2.246.562.10.00000000001|"}))

    (GET "/organisaatio-service/api/1.2.246.562.10.54425555" []
      (mock-gen/json-response
        {:oid "1.2.246.562.10.54425555"
         :nimi {:fi "Joku koulutuksen järjestäjä-organisaatio"}
         :parentOidPath "|1.2.246.562.10.00000000001|"}))

    (GET "/organisaatio-service/api/1.2.246.562.10.54424444" []
      (mock-gen/json-response
        {:oid "1.2.246.562.10.54424444"
         :nimi {:fi "Aiemman arvioijan organisaatio"}
         :parentOidPath "|1.2.246.562.10.00000000001|"}))

    (GET "/organisaatio-service/api/1.2.246.562.10.54423333" []
      (mock-gen/json-response
        {:oid "1.2.246.562.10.54423333"
         :nimi {:fi "Osa-alueen järjestäjä-organisaatio"}
         :parentOidPath "|1.2.246.562.10.00000000001|"}))

    (GET "/organisaatio-service/api/1.2.246.562.10.21122461771" []
      (mock-gen/json-response-file
        "dev-routes/organisaatio-service_api_1.2.246.562.10.21122461771.json"))

    (GET "/organisaatio-service/api/:oid" [oid]
      (mock-gen/json-response
        {:oid oid
