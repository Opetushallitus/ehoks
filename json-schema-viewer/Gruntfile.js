...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      ...
      prod: ["../resources/public/json-viewer/**/*"],
    ...
    uglify: {
      prod: {
        ...
        files: {
          "../resources/public/json-viewer/<%= pkg.name %>.min.js": [
          ...
          "../resources/public/json-viewer/lib/preinit.js": ["./lib/preinit.js"]
        }
      }
    },
    ...
    sass: {
      ...
      prod: {
        ...
        src: "./styles/sass/<%= pkg.name %>.scss",
        dest: "../resources/public/json-viewer/styles/<%= pkg.name %>.min.css"
      }
    },
    ...
    preprocess: {
      ...
      prod: {
        files: [
          {
            src: "./templates/index.html",
            dest: "../resources/public/json-viewer/index.html"
          },

          // {
          //   src: "./templates/latest.html",
          //   dest: "./prod/latest.html"
          // },

          {
            src: "./templates/basic.html",
            dest: "../resources/public/json-viewer/basic.html"
          }
        ]
      }
    },
        ...
        files: [
          {
            ...
            dest: "../resources/public/json-viewer/"
          }
          // {
          //   expand: true,
