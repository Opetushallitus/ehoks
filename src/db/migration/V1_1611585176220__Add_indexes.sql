...
CREATE INDEX osaamisen_osoittamisen_sisallot_deleted_at_idx
    ON osaamisen_osoittamisen_sisallot(deleted_at);
...
CREATE INDEX osaamisen_osoittamisen_yksilolliset_kriteerit_deleted_at_idx
    ON osaamisen_osoittamisen_yksilolliset_kriteerit(deleted_at);
...
CREATE INDEX tyopaikalla_jarj_koulutuksen_tyotehtavat_deleted_at_idx
    ON tyopaikalla_jarjestettavan_koulutuksen_tyotehtavat(deleted_at);
...
CREATE INDEX aiemmin_hankitut_yto_osa_alueet_deleted_at_idx
    ON aiemmin_hankitut_yto_osa_alueet(deleted_at);
...
CREATE INDEX yhteisen_tutkinnon_osan_osa_alueet_deleted_at_idx
    ON yhteisen_tutkinnon_osan_osa_alueet(deleted_at);

-- Table osaamisen_osoittamiset
CREATE INDEX osaamisen_osoittamiset_id_idx
    ON osaamisen_osoittamiset(id);

CREATE INDEX osaamisen_osoittamiset_deleted_at_idx
    ON osaamisen_osoittamiset(deleted_at);
...
CREATE INDEX koodisto_koodit_id_idx
    ON koodisto_koodit(id);

CREATE INDEX koodisto_koodit_deleted_at_idx
    ON koodisto_koodit(deleted_at);

-- Table osaamisen_osoittamisen_osa_alueet
CREATE INDEX osaamisen_osoittamisen_osa_alueet_deleted_at_idx
    ON osaamisen_osoittamisen_osa_alueet(deleted_at);
...
CREATE INDEX aiemm_hank_paikallisen_tutkinnon_osan_naytto_deleted_at_idx
    ON aiemmin_hankitun_paikallisen_tutkinnon_osan_naytto(deleted_at);
...
CREATE INDEX hankittavan_paikallisen_tutkinnon_osan_naytto_deleted_at_idx
    ON hankittavan_paikallisen_tutkinnon_osan_naytto(deleted_at);
...
CREATE INDEX koulutuksen_jarjestaja_osaamisen_arvioijat_id_idx
    ON koulutuksen_jarjestaja_osaamisen_arvioijat(id);

CREATE INDEX koulutuksen_jarjestaja_osaamisen_arvioijat_deleted_at_idx
    ON koulutuksen_jarjestaja_osaamisen_arvioijat(deleted_at);
...
CREATE INDEX osaam_osoitt_koulutuksen_jarjestaja_arvioija_deleted_at_idx
    ON osaamisen_osoittamisen_koulutuksen_jarjestaja_arvioija(deleted_at);
...
CREATE INDEX tyoelama_osaamisen_arvioijat_id_idx
    ON tyoelama_osaamisen_arvioijat(id);
...
CREATE INDEX osaamisen_osoittamisen_tyoelama_arvioija_deleted_at_idx
    ON osaamisen_osoittamisen_tyoelama_arvioija(deleted_at);
...
CREATE INDEX osaamisen_hankkimistavat_id_idx
    ON osaamisen_hankkimistavat(id);
...
CREATE INDEX todennettu_arviointi_arvioijat_deleted_at_idx
    ON todennettu_arviointi_arvioijat(deleted_at);
...
CREATE INDEX aiemmin_hankitun_yhteisen_tutkinnon_osan_naytto_deleted_at_idx
    ON aiemmin_hankitun_yhteisen_tutkinnon_osan_naytto(deleted_at);
...
CREATE INDEX aiemmin_hankitun_yto_osa_alueen_naytto_deleted_at_idx
    ON aiemmin_hankitun_yto_osa_alueen_naytto(deleted_at);
...
CREATE INDEX hankittavan_ammat_tutkinnon_osan_naytto_deleted_at_idx
    ON hankittavan_ammat_tutkinnon_osan_naytto(deleted_at);
...
CREATE INDEX hank_ammat_tutk_osan_osaamisen_hankkimistavat_deleted_at_idx
    ON hankittavan_ammat_tutkinnon_osan_osaamisen_hankkimistavat(deleted_at);
...
CREATE INDEX yht_tutk_osan_osa_alueen_osaam_hankkimistavat_deleted_at_idx
    ON yhteisen_tutkinnon_osan_osa_alueen_osaamisen_hankkimistavat(deleted_at);
...
CREATE INDEX yhteisen_tutkinnon_osan_osa_alueen_naytot_deleted_at_idx
    ON yhteisen_tutkinnon_osan_osa_alueen_naytot(deleted_at);
...
CREATE INDEX hankittavat_paikalliset_tutkinnon_osat_deleted_at_idx
    ON hankittavat_paikalliset_tutkinnon_osat(deleted_at);
...
CREATE INDEX hankittavat_yhteiset_tutkinnon_osat_deleted_at_idx
    ON hankittavat_yhteiset_tutkinnon_osat(deleted_at);
...
CREATE INDEX hankittavat_ammat_tutkinnon_osat_deleted_at_idx
    ON hankittavat_ammat_tutkinnon_osat(deleted_at);

CREATE INDEX hankittavat_ammat_tutkinnon_osat_hoks_id_idx
    ON hankittavat_ammat_tutkinnon_osat(hoks_id);

-- Table hoksit
CREATE INDEX hoksit_deleted_at_idx
    ON hoksit(deleted_at);
