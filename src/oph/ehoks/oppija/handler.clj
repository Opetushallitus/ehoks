(ns oph.ehoks.oppija.handler
  (:require [compojure.api.sweet :as c-api]
            ...
            [oph.ehoks.middleware :refer [wrap-public]]))

(def public-routes
  [ {:uri #"^/ehoks-backend/api/v1/oppija/session/opintopolku/$"
    :request-method :get}
   {:uri #"^/ehoks-backend/api/v1/oppija/session$"
...
(def routes
  (wrap-routes oppija-routes wrap-public public-routes))
