...
(defn get-hankittava-paikallinen-tutkinnon-osa [id]
  (assoc
    ...
    (c/get-osaamisen-osoittaminen id)
    :osaamisen-hankkimistavat
    (c/get-osaamisen-hankkimistavat id)))
...
(defn get-hato-osaamisen-hankkimistavat [id]
  (mapv
    c/set-osaamisen-hankkimistapa-values
  ...
  (mapv
    #(let [osa-alue-db (db/insert-yhteisen-tutkinnon-osan-osa-alue!
       ...
       (assoc
         ...
         (mapv
           (fn [hon]
             (c/save-yto-osa-alueen-osaamisen-osoittaminen! osa-alue-db hon))
           (:osaamisen-osoittaminen %))))
    osa-alueet))
